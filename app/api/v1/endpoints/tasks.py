...
def read_tasks(
    ...
    if project_id:
        ...
        if current_user.role != models.UserRole.ADMIN:
            ...
            query = query.join(models.Project).filter(models.Project.owner_id == current_user.id)
...
def read_task(
    *,
    ...
    if cached_task:
        ...
        if current_user.role != models.UserRole.ADMIN and cached_task["owner_id"] != current_user.id:
            raise HTTPException(status_code=400, detail="Not enough permissions")
        return cached_task
